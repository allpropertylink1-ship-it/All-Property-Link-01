        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex flex-col rounded-3xl border-2 border-accent-500/60 bg-surface p-5 sm:p-6">
                {/* Mobile skeleton */}
                <div className="lg:hidden">
                  <div className="mx-auto h-[130px] w-[130px] rounded-full border-2 border-accent-500/70 p-[3px]">
                ...
                <div className="hidden lg:flex gap-7">
                  <div className="h-[150px] w-[150px] shrink-0 self-center rounded-full border-2 border-accent-500/70 p-[3px]">
                    <div className="h-full w-full rounded-full bg-surface-secondary animate-pulse" />
                  </div>
                  <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    <div className="mt-auto pt-5"><div className="border-t border-accent-500/60" /></div>
                  </div>
                </div>
