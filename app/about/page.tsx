...
function SellIcon() {
  return (
    <svg className="mx-auto mb-4 h-9 w-9 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="min-h-[calc(100dvh-80px)] bg-surface">
        ...
        <section className="mx-auto max-w-7xl px-4 py-16">
          ...
          <div className="mb-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Link href="/properties" className="group rounded-lg border border-border bg-surface p-8 text-center transition-colors hover:border-accent-500">
              <SellIcon />
            ...
            <Link href="/properties?purpose=FOR_RENT_LONG_TERM" className="group rounded-lg border border-border bg-surface p-8 text-center transition-colors hover:border-accent-500">
              <KeyIcon />
            ...
            <Link href="/properties?purpose=FOR_RENT_SHORT_TERM" className="group rounded-lg border border-border bg-surface p-8 text-center transition-colors hover:border-accent-500">
              <PalmIcon />
            ...
            <Link href="/services" className="group rounded-lg border border-border bg-surface p-8 text-center transition-colors hover:border-accent-500">
              <WrenchIcon />
          ...
          <section className="rounded-lg bg-surface-secondary p-8 text-center md:p-12">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/properties"
                className="touch-target inline-flex items-center justify-center rounded-lg bg-primary px-8 py-3 font-medium text-white transition-colors hover:bg-primary-600"
              >
                Explore Listings
              </Link>
              <Link
                href="/auth/register"
                className="touch-target inline-flex items-center justify-center rounded-lg border border-border bg-surface px-8 py-3 font-medium text-text-primary transition-colors hover:border-accent-500"
              >
