  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-80px)] bg-surface">
        <section className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 px-4 py-20 text-center text-text-on-primary">
        ...
        <section className="mx-auto max-w-7xl px-4 py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-3 mb-16">
            <div className="rounded-xl border border-border bg-surface p-8 text-center">
              <div className="text-4xl font-bold text-primary-600 font-heading mb-2">10,000+</div>
              <div className="text-text-secondary">Active Listings</div>
            </div>
            <div className="rounded-xl border border-border bg-surface p-8 text-center">
              <div className="text-4xl font-bold text-primary-600 font-heading mb-2">5,000+</div>
              <div className="text-text-secondary">Verified Agents</div>
            </div>
            <div className="rounded-xl border border-border bg-surface p-8 text-center">
              <div className="text-4xl font-bold text-primary-600 font-heading mb-2">50,000+</div>
          ...
          <section className="bg-primary-50 rounded-2xl p-8 md:p-12 text-center">
            <h2 className="font-heading text-2xl sm:text-3xl font-bold text-primary-900 mb-4">
              Built for Kenya&apos;s Market
            </h2>
            <p className="mx-auto max-w-2xl text-primary-800 mb-8">
            ...
            <a
              href="/contact"
              className="touch-target inline-flex items-center justify-center rounded-lg bg-primary-600 px-8 py-3 font-medium text-text-on-primary hover:bg-primary-700 transition-colors"
            >
